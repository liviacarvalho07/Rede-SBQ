...
<head>
    ...
    <link rel="icon" type="image/png" href="assents/img/ds.png">
    <title>Rede SBQ</title>
    ...
    <link rel="stylesheet" href="itens_navbar_padrao_index/assets/css/style.css">
    <link rel="stylesheet" href="itens_navbar_padrao_index/SobreSBQ/style.css">
</head>
<body>
    <header>
        <nav class="nav-bar">
            <div class="central">
                <div class="logo">
                    <img src="itens_navbar_padrao_index/assets/img/logo.jpeg" alt="" width="200px">
              </div>
            
                <div class="nav-options">
                    <!-- Itens do NavBar -->
                    <ul>
                        <li class="nav-item"><a href="itens_navbar_padrao_index/sobreSBQ.php" class="nav-link">Sobre a Plataforma</a></li>
                        <li class="nav-item"><a href="itens_navbar_padrao_index/manual.pdf" class="nav-link">Manual</a></li>
                        <li class="nav-item"><a href="itens_navbar_padrao_index/exame.php" class="nav-link">Exame Unificado de Química</a></li>
                    </ul>
                </div>
                  ...
                  <ul style="list-style-type: none;">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                          ...
                          <li><a class="dropdown-item" href="Index/acessar_funcional.php">Login Institucional</a></li>
                          <li><hr class="dropdown-divider"></li>
                          <li><a class="dropdown-item" href="Index/cadastro_pessoal.php">Cadastro Pessoal</a></li>
                          <li><a class="dropdown-item" href="Index/cadastro_funcional.php">Cadastro Institucional</a></li>
                        </ul>
                    </li>
                  </ul>
                </div>
    ...
    <div class="barra">
      <div class="quadrado">
        <div class="diretorio">
            <a href="index.php"><img src="itens_navbar_padrao_index/assets/img/casa.png" alt="Home"></a>
            > 
        </div>
      </div>
    ...
    <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="itens_navbar_padrao_index/assets/img/tela1.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="itens_navbar_padrao_index/assets/img/tela2.png" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="itens_navbar_padrao_index/assets/img/tela3.png" class="d-block w-100" alt="...">
          </div>
        </div>
    ...
    <div class="inform">
        ...
        <div class="titulo">
            <h2><img class="casa" src="itens_navbar_padrao_index/assets/img/house.png" alt="">Bem vindo à SBQ</h2>
