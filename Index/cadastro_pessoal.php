        ...
        <form action="../dependencies/userpessoal_cadastro.php" method="post">
          ...
          <div class="row">
            <div class="col-sm">
              ...
              <div class="form-group">
                <select id="seletores-titulacao" class="form-select form-select-sm" name="instituicao-titulacao">
          ...
          <div class="row">
            ...
            <div class="col-sm">
              ...
              <div class="form-group">
                <select id="seletores-atual" class="form-select form-select-sm" name="instituicao-atual">
                  <option selected></option>
                </select>
              </div>
            </div>
