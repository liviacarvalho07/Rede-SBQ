...
<div class="container">
  ...
  <div class="form">
    ...
    <form action="../dependencies/userequipamento_cadastro.php" method="post">
    <div class="row">
    ...
    <div class="row">
      ...
      <div class="col-sm" id="colunas">
        <label for="">CEP:</label>
        <input type="text" class="form-control" name="cep" onblur="buscaCep(this.value)" />
      </div>
      <div class="col-sm" id="colunas">
    ...
    <div class="row">
      ...
      <div class="col-sm" id="colunas">
        <label for="">Nome do Laboratório do Equipamento:</label>
  ...
  <script src="assets/js/viacp.js"></script>
