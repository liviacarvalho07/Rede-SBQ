<?php include "navbar_index_itens.php"?>
    ...
    <div class="form">
      ...
      <!-- Barra 2 -->
      <div class="cad">Cadastre o Laboratório</div>
      <div class="linha"></div>

      <!-- LINHA 1 DO FORMULÁRIO -->
      <form action="../dependencies/userlaboratorio_cadastro.php" method="post">
      ...
      <div class="col-sm" id="colunas">
        <div class="row" id="add">
          <button class="adicionar" name="submit" type="submit">Adicionar Laboratório</button>
        </div>
      </div>
    </div>
