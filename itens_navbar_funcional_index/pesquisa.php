...
<div class="barra">
    <div class="quadrado">
        <div class="diretorio">
            <a href="tela_inicial_funcional.php"><img src="../itens_navbar_pessoal_index/assets/img/casa.png" alt="Home"></a>
            >
        </div>
    </div>
...
<div class="catalogo">
    ...
    ?>
        <div class="quad_catalogo">
            <div class="img-equi" style="background-image: url('https://img.freepik.com/vetores-premium/design-de-icone-de-tubo-quimico-biologia-liquida-sinal-e-simbolo-de-quimica_752732-712.jpg'); background-size:contain;"></div>
